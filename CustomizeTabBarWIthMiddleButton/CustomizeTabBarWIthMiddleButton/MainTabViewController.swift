...
class MainTabViewController: UITabBarController, UITabBarControllerDelegate {
    ...
    // colours
    let bgColor = UIColor(named: "lightColor")
    let sColor = UIColor(named: "accentColor")
    let tColor = UIColor(named: "ShadowColor")
    ...
    var middleButton: UIButton = {
        ...
        b.backgroundColor = UIColor(named: "viewColor")
        return b
    }()
    ...
    // MARK: - Tab bar
    //setting up tab bar, with layers and corner radius
    func setUpTabBar() {
    ...
    //MARK: function for middle button
    @objc func buttonHandler(sender: UIButton) {
        
        // define background color
        let buttonBGColor = UIColor(named: "viewColor")
    ...
    //MARK: setting up buttons that opens by middle button clicks
